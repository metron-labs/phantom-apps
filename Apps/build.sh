...
ssh $PHANTOM_USER@$PHANTOM_SERVER "cd phcybereason && phenv python3 /opt/phantom/bin/py3/compile_app.pyc -i"
...
rm -rf $DIST_DIR
mkdir -p $DIST_DIR
RELEASE_FILE=$DIST_DIR/phcybereason-`git log --pretty=format:'%h' -n 1`.tgz
